...
enum InvalidModels : Hash
{
	VEHICLE_CYCLONE2 = RAGE_JOAAT("CYCLONE2"),
	VEHICLE_ARBITERGT = RAGE_JOAAT("ARBITERGT"),
	VEHICLE_S95 = RAGE_JOAAT("S95"),
	VEHICLE_ASTRON2 = RAGE_JOAAT("ASTRON2"),
	VEHICLE_IGNUS2 = RAGE_JOAAT("IGNUS2")
};