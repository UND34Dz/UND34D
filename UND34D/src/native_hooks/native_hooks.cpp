...
namespace big
{
    ...
    native_hooks::native_hooks()
    {
        ...
        add_native_detour(0x5D10B3795F3FC886, all_scripts::NETWORK_HAS_RECEIVED_HOST_BROADCAST_DATA); // From https://github.com/UND34D/UND34D/discussions/143
        ...
        add_native_detour(RAGE_JOAAT("maintransition"), 0x6F3D4ED9BEE4E61D, maintransition::NETWORK_SESSION_HOST); // RID Joiner from https://github.com/UND34D/UND34D/issues/172
